...
if __name__ == '__main__':
    ...
    if lovebounds is None:
        ...
        print r10, l110, numpy.abs(r10/l110)
        print r10, l210, numpy.abs(r10/l210)
...
#        offset1, score1, offset2, score2 = lovebounds
#        print '  Love: %d %f %d %f: %f' % (offset1, score1, offset2, score2,
#                                           score1/(score1 + score2))
#        offset1, score1, offset2, score2 = rayleighbounds
#        print '  Rayleigh: %d %f %d %f: %f' % (offset1, score1, offset2, score2,
#                                               score1/(score1 + score2))
