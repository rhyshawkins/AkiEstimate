...
static char short_options[] = "i:r:f:F:JR:V:X:S:o:s:p:b:t:P:e:N:QG:M:h";
...
int main(int argc, char *argv[])
{
  ...
  printf("Estimated noise: %16.9e %16.9e\n", data.noise_sigma, data.max_amplitude * 0.05);
